...
from .config import SESSION_META_JSON, SESSION_META_CSV, SESSION_META_H5, PROJECT_INFO_JSON, ANIMAL_INFO_JSON
...
def save_animal_info(animal_dir: str, info: Dict):
    save_json(os.path.join(animal_dir, ANIMAL_INFO_JSON), info)

def load_animal_info(animal_dir: str) -> Dict:
    return load_json(os.path.join(animal_dir, ANIMAL_INFO_JSON)) or {}
